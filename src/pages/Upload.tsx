...
Generate relevant questions and answers based on the actual PDF content. Use difficulty levels: easy, medium, hard.`,
          ...
          toast({
            ...
            description: `Could not analyze ${file.name} with AI. Using fallback data.`,
            variant: "destructive",
          });
      ...
      toast({
        ...
        description: "Your PDFs have been analyzed with AI and flashcards created. Redirecting to dashboard...",
      });
